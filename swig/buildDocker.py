...
def main():
	...
	if os.name == "posix":
		...
		os.system('sudo docker run -it dnnc /bin/bash -c "cd /dnnCompiler/swig && make clean && make"')
	...
	# Windows
		...
		os.system('docker run -it dnnc /bin/bash -c "cd /dnnCompiler/swig && make clean && make"')
