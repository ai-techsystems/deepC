...
class GreaterEqualTest(unittest.TestCase):
    def setUp(self):
        self.len = 24
    ...
    def test_GreaterEqual1D (self):
        npr = np.greater_equal(self.np_a, self.np_b)
        dcr = dc.greater_equal(self.dc_a, self.dc_b)
        np.testing.assert_array_equal(npr, np.array(dcr.data()))

    def test_GreaterEqual2D_1 (self):
        np_a = np.reshape(self.np_a, (6,4))
        np_b = np.reshape(self.np_b, (6,4))
        dc_a = dc.reshape(self.dc_a, (6,4))
        dc_b = dc.reshape(self.dc_b, (6,4))
        npr = np.greater_equal(np_a, np_b)
        dcr = dc.greater_equal(dc_a, dc_b)
        np.testing.assert_array_equal(npr.flatten(), np.array(dcr.data()))

    def test_GreaterEqual2D_2 (self):
    ...
    def test_GreaterEqual2D_3 (self):
    ...
    def test_GreaterEqual3D_1 (self):
    ...
    def test_GreaterEqual3D_2 (self):
    ...
    def test_GreaterEqual3D_3 (self):
    ...
    def test_GreaterEqual4D_1 (self):
    ...
    def test_GreaterEqual4D_2 (self):
