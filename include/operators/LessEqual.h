...
namespace dnnc {
/*! Returns the tensor resulted from performing the less than or equal to logical operation
...
public:
  LessEqual(std::string name = "opLessEqual") : baseOperator<T>(opLessEqual, name) {}
